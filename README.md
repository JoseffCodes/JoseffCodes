...
- 🔧 **Freelance web dev** — full sites for trades and local businesses (carpentry, plumbing, cleaning, joinery), front-end to back-end, including PHP sites with admin panels and MySQL
